...
<template>
  <nav>
    ...
    <RouterLink to="/bid" title="Заявки с сайта">
      <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill="#707a8a" class="bi bi-support-left-text" viewBox="0 0 16 16">
        <path
    ...
    <RouterLink to="/user" title="Пользователи">
      <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" fill="#707a8a" viewBox="0 0 16 16">
        <path
